...
export default function CustomArcadeForm({
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        screen_accessory_id:
            initialValues?.screen_accessory_id?.toString?.() ?? "",
        joystick_accessory_id:
            initialValues?.joystick_accessory_id?.toString?.() ?? "",
        console_accessory_id:
            initialValues?.console_accessory_id?.toString?.() ?? "",
        skin_accessory_id: initialValues?.skin_accessory_id?.toString?.() ?? "",
        target_accessory_id:
            initialValues?.target_accessory_id?.toString?.() ?? "",
    });
    const submit = (event) => {
